 ...
 * Reset to default anycubic ultrabase
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.18   // Z offset: -below +above  [the nozzle]
...
#define Z_PROBE_SPEED_SLOW (HOMING_FEEDRATE_Z_ORIGINAL / 2)
...
#define HOMING_FEEDRATE_Z_ORIGINAL  (4*60) // added for speedup
